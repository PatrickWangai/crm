...
export const DEMO_ACCOUNTS: DemoAccount[] = [
  ...
  { firstName: "Head of", lastName: "Customer Care", email: "customer-care@masterways.co.ke", password: "TnmZ9wv$36w", roleSlug: "customer-care", departmentCode: "CARE", businessUnitCode: "MGC", jobTitle: "Customer Care Agent" },
