...
/**
 * Deterministic keyword-based classifier standing in for a real NLP/LLM call.
 * Swap for an API call once AI_ASSISTANT's IntegrationConfig status moves
 * from MOCK to CONNECTED. Pure and client-safe — no DB/auth dependency —
 * so it can run live in the ticket form as the user types.
 */
