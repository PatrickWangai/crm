...
import { TICKET_CATEGORIES, TICKET_PRIORITIES, TICKET_STATUSES } from "@/lib/validation/ticket";
...
export function TicketFilters({ view }: { view: "table" | "kanban" }) {
    ...
    <div className="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
      <div className="flex flex-col gap-3 sm:flex-row sm:items-center">
        <div className="relative flex-1 sm:max-w-xs">
          ...
          <Input
            placeholder="Search subject, ticket #, stakeholder..."
