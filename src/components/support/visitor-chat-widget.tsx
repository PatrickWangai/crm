 ...
 * staff member has messaged first from Live Activity (see
 * staff-chat-panel.tsx's session-based mode), or proactively, when the
 * visitor clicks "Chat with our team" inside HelpChatbot (see
